...
class EnrollmentApp:
    ...
    def record_next_sample(self, username):
        ...
        msg += "Instructions:\n"
        msg += "• Press OK to start recording\n"
        msg += "• Tap the pattern using SPACEBAR\n"
        msg += "• Short press = dot, Long press = dash\n"
        msg += "• Press ENTER when finished\n\n"
        ...
        self.status_label.config(
            text="🔴 RECORDING... Tap your pattern now! (Press ENTER when done)",
            fg=ERROR
        )
